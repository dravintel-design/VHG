...
function ContactPage() {
  ...
  const [form, setForm] = useStateC({ name: "", email: "", phone: "", interest: "Site visit", project: "Any project", message: "" });
...
ReactDOM.createRoot(document.getElementById("page-app")).render(<ContactPage />);
