    ...
    <React.Fragment>
      ...
      <section className="page-body" data-screen-label="02 Programs">
        ...
        <div className="program-list">
          {PROGRAMS.map(p => (
            <div className="program-row" key={p.id} id={p.id}>
              ...
              <div className="program-cta">
                <a className="btn-primary" href="contact.html">Apply Now</a>
                <a className="btn-secondary" href="contact.html">Download Deck</a>
              </div>
            </div>
          ))}
        </div>
...
ReactDOM.createRoot(document.getElementById("page-app")).render(<PartnersPage />);
